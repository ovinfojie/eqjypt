...
const mockData: Row[] = [
  {
    id: "ZZXQ20260501001", orderId: "XQ20260501001", applicant: "平远新供销天润粮油有限公司",
    title: "2026年广东省内计划大量采购丝苗米", product: "丝苗米", qty: "9000公斤",
    reason: "因市场行情变化，采购计划调整，申请终止该需求。", applyTime: "2026-04-20 10:12", status: "待审核",
  },
  {
    id: "ZZXQ20260501002", orderId: "XQ20260501002", applicant: "江门新供销天润农业发展有限公司",
    title: "2026年广东省内计划大量采购菠萝干", product: "菠萝干", qty: "8000公斤",
    reason: "上游供应不足，暂停本次采购需求。", applyTime: "2026-04-19 15:40", status: "待审核",
  },
  {
    id: "ZZXQ20260501003", orderId: "XQ20260501003", applicant: "东莞新供销天润农产品有限公司",
    title: "2026年广东省内计划大量采购象牙香占", product: "象牙香占", qty: "2吨",
    reason: "预算削减，终止采购。", applyTime: "2026-04-15 09:20", status: "已通过",
  },
  {
    id: "ZZXQ20260501004", orderId: "XQ20260501004", applicant: "广东汕头潮阳天润粮油有限公司",
    title: "2026年广东省内计划大量采购恩平土豆", product: "土豆", qty: "7000公斤",
    reason: "重复提交，申请终止。", applyTime: "2026-04-12 14:05", status: "已驳回",
    rejectReason: "该需求已有卖家报价并进入履约阶段，不符合终止条件。",
  },
]
...
export default function ZhongzhiXqPage() {
      ...
      <div className="bg-white rounded-lg border border-[#dde3ec] mb-4">
        ...
        <div className="flex items-center gap-3 p-4">
          <div className="relative flex-1 max-w-sm">
            ...
            <input type="text" placeholder="搜索终止申请编号、需求标题、申请企业"
      ...
      <div className="bg-white rounded-lg border border-[#dde3ec] overflow-hidden">
        <table className="w-full text-[13px]">
          <thead className="bg-[#f5f7fa]">
            <tr>
              {["终止申请编号", "关联需求", "申请企业", "商品/数量", "终止原因", "申请时间", "状态", "操作"].map((h) => (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40" onClick={() => setDetailRow(null)}>
          <div className="bg-white rounded-lg w-[560px] shadow-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#e8edf5]">
              <h3 className="text-[16px] font-bold text-[#1a1a2e]">终止需求详情</h3>
            ...
            <div className="px-6 py-5 space-y-3 text-[13px]">
              {[
                ["终止申请编号", detailRow.id],
                ["关联需求编号", detailRow.orderId],
                ["需求标题", detailRow.title],
