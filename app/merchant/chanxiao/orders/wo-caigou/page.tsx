...
const ORDERS = [
  { id: "2434059405460956", time: "2026-04-20 22:05:48", product: "丝苗米、南晶香占", amount: 2300, deposit: 230, seller: "广州增城供销农产品配送有限公司", receiver: "偶奇", phone: "138****8888", address: "上海市浦东新区市镇区2888号", delivery: "卖家配送", planTime: "2026-04-23 00:00:00 至 2026-04-25 23:59:59", status: "待发货", isGroup: false },
  { id: "2434059405460957", time: "2026-04-10 22:05:48", product: "菠萝、土豆", amount: 5000, deposit: 500, seller: "广州番禺供销农产品配送有限公司", receiver: "张悦", phone: "13647589768", address: "广州市越秀区荣园东路80号", delivery: "买家自提", planTime: "2026-04-13 00:00:00 至 2026-04-16 23:59:59", status: "待发货", isGroup: false },
  { id: "2434059405460958", time: "2026-04-09 22:05:48", product: "象牙香占、香雪", amount: 27000, deposit: 270, seller: "广州市海珠区供销农产品有限公司", receiver: "张翰", phone: "1234567898", address: "广东省肇庆市云顶花园83号", delivery: "卖家配送", planTime: "2026-04-23 00:00:00 至 2026-04-25 23:59:59", status: "待发货", isGroup: true },
  { id: "2434059405460955", time: "2026-04-06 22:05:48", product: "土豆、豇豆", amount: 6000, deposit: 600, seller: "汕尾吉康供销农产品有限公司", receiver: "张含", phone: "13453679768", address: "广州市越秀区荣园东路79号", delivery: "卖家配送", planTime: "2026-04-23 00:00:00 至 2026-04-25 23:59:59", status: "待卖方确认", isGroup: true },
  { id: "2434059405460955", time: "2026-04-05 22:05:48", product: "菜心", amount: 7000, deposit: 700, seller: "广州白云供销农产品配送有限公司", receiver: "张启明", phone: "13457379768", address: "广州市越秀区荣园东路66号", delivery: "卖家配送", planTime: "2026-04-23 00:00:00 至 2026-04-25 23:59:59", status: "待付预付款", isGroup: false },
]

const STATUS_TABS = ["全部", "待卖方确认", "待付预付款", "待发货", "待收货", "待结算", "已完成/已取消"]

const CHANGEABLE = new Set(["待卖方确认", "待付预付款", "待发货", "生产履约"])
const CANCELABLE = new Set(["待卖方确认", "待付预付款", "待发货", "生产履约"])

const MAIN_ACTIONS: Record<string, { label: string; color: string }> = {
  "待付预付款": { label: "付预付款",   color: "text-[#e8831a]" },
  "待发货":     { label: "终止发货",   color: "text-[#e04040]" },
  "待收货":     { label: "验收",       color: "text-[#1a5fa8]" },
  "待结算":     { label: "查看对账单", color: "text-[#1a5fa8]" },
}

export default function ChanxiaoWoCaigouPage() {
      ...
      <div className="bg-white rounded-lg border border-[#dde3ec] overflow-hidden">
        ...
        <div className="p-4 border-b border-[#e8edf5]">
          <div className="grid grid-cols-4 gap-3 mb-3">
            ...
            <div>
              <label className="text-[12px] text-[#666] block mb-1">卖方</label>
          ...
          <div className="grid grid-cols-4 gap-3">
            <div className="col-span-2">
              ...
              <div className="flex items-center gap-1">
                <input type="text" placeholder="开始日期" value={dateStart} onChange={e => setDateStart(e.target.value)}
                  className="flex-1 h-8 border border-[#dde3ec] rounded px-2 text-[12px] outline-none focus:border-[#1a5fa8]" />
                <span className="text-[#999] text-[12px]">至</span>
                <input type="text" placeholder="结束日期" value={dateEnd} onChange={e => setDateEnd(e.target.value)}
                  className="flex-1 h-8 border border-[#dde3ec] rounded px-2 text-[12px] outline-none focus:border-[#1a5fa8]" />
        ...
        <div className="grid text-[12px] text-[#6b7c93] bg-[#f8fafc] border-b border-[#e8edf5] px-4 py-2"
          ...
          {["商品","下单金额","预付款金额","卖方","收货人信息","配送方式","计划收货时间","是否集采下单","订单状态","操作"].map(h => (
              ...
              <div key={order.id + order.time} className="border-b border-[#e8edf5] last:border-0">
                ...
                <div className="px-4 py-2 bg-[#fafbfc] flex items-center gap-4 text-[12px] text-[#666]">
                  ...
                  <div className="ml-auto flex gap-2">
                    <Link href={`/merchant/chanxiao/orders/wo-caigou/${order.id}`} className="text-[#1a5fa8] hover:underline">查看详情</Link>
                    <span className="text-[#dde3ec]">|</span>
                    <span className="text-[#999] cursor-pointer hover:text-[#1a5fa8]">联系卖方</span>
                  </div>
                </div>
