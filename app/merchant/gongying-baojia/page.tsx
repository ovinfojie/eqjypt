          ...
          <div className="p-6">
            ...
            <div className="border border-[#dde3ec] rounded-lg p-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="text-[14px] font-semibold text-[#1a1a2e] mb-0.5">
                    2026年广东省内计划大量采购丝苗米
                  </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-4 text-[13px]">
                <div>
                  <span className="text-[#6b7c93]">期望收货周期：</span>
                  <span className="text-[#333]">2026-04-23 至 2026-04-25 23:59:59</span>
                </div>
                <div>
                  <span className="text-[#6b7c93]">报价模式：</span>
                  <span className="text-[#333]">可以修改报价</span>
                  <div className="flex items-center gap-1 mt-0.5">
                    <Info className="w-3.5 h-3.5 text-[#1a5fa8]" />
                    <span className="text-[12px] text-[#1a5fa8]">当前报价提交后，买方未下单前可随时修改报价</span>
                  </div>
                </div>
                <div>
                  <span className="text-[#6b7c93]">报价截止时间：</span>
                  <span className="text-[#333]">2026-04-25 23:59:59</span>
                </div>
                <div>
                  <span className="text-[#6b7c93]">收购标准：</span>
                  <span className="text-[#333]">GB/T 1354 大米</span>
                  <button className="ml-2 text-[#1a5fa8] text-[12px] hover:underline">查看标准详情&gt;&gt;</button>
                </div>
                <div className="col-span-2">
                  <span className="text-[#6b7c93]">备注信息：</span>
                  <span className="text-[#333]">要求米粒完整、无霉变，水分含量≤14.5%，垩白度≤5%。需提供质检报告。</span>
                </div>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-4">
                {/* Selected product */}
                <div className="flex-1 border border-[#1a5fa8] rounded-lg p-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="mt-2 text-[12px] text-[#6b7c93]">
                    <span>粮油类/大米类/籼米</span>
                    <span className="mx-2">·</span>
                    <span>市集SPU编码P626342237328</span>
                    <span className="mx-2">·</span>
                    <span>主数据SPU编码P123456789</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6">
              <h3 className="text-[14px] font-semibold text-[#1a1a2e] mb-3">
                <span className="text-red-500 mr-1">*</span>选择规格
              </h3>
              <table className="w-full text-[13px] border border-[#dde3ec] rounded overflow-hidden">
                <thead className="bg-[#f5f7fa]">
                  <tr>
                    ...
                    {["平台SKU编码", "主数据SKU编码", "规格名称", "预估供应量(单位)", "", "报价单价(元)", "上一次报价单价(元)", "报价单价(元)", "金额(元)"].map((h, i) => (
                      <th key={i} className="px-3 py-2 text-left font-medium text-[#444] border-b border-[#dde3ec]">{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr key={i} className="border-b border-[#dde3ec] last:border-0">
                      ...
                      <td className="px-3 py-3">
                        <input
                          ...
                          className="w-20 h-7 border border-[#dde3ec] rounded px-2 text-[13px] outline-none focus:border-[#1a5fa8]"
                        />
                      </td>
              ...
              <div className="text-right mt-2 text-[13px] text-[#6b7c93]">
                已选 <span className="text-[#1a1a2e] font-medium">2</span> 个规格商品，总供货量{" "}
                <span className="text-[#1a1a2e] font-medium">5100 kg</span>，报价合计{" "}
                <span className="text-[#1a5fa8] font-bold text-[14px]">¥100000.00</span>
              </div>
            </div>
            ...
            <div className="mb-6 p-4 bg-[#f5f7fa] rounded border border-[#dde3ec]">
              <label className="block text-[13px] font-medium text-[#333] mb-2">
                <span className="text-red-500 mr-1">*</span>收购标准
              </label>
            ...
            <div className="flex justify-center gap-4 pt-2 border-t border-[#dde3ec]">
              <button className="px-8 py-2.5 border border-[#dde3ec] text-[#444] text-[14px] rounded hover:bg-[#f5f7fa] transition-colors">
                取消
              </button>
